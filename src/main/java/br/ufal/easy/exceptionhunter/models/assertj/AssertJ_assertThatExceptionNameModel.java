 ...
 */
public class AssertJ_assertThatExceptionNameModel extends AbstractOrdinaryModel {
    ...
    public AssertJ_assertThatExceptionNameModel() {
    ...
    public String toString() {
        return "AssertJ_assertThatExceptionNameModel{" +
